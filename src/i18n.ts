...
const translations: Record<string, string> = {
  ...
  '按住看原图': 'Hold to view original',
  '原图对比中 · 点按退出': 'Comparing original · tap to exit',
  '原图 · 仅保留裁剪': 'Original · crop only',
  '图层': 'Layers',
  '设为激活图层': 'Set as active layer',
  '隐藏图层': 'Hide layer',
  '显示图层': 'Show layer',
  '单独导出此层': 'Export this layer',
  '删除图层': 'Delete layer',
  '双击重命名': 'Double-click to rename',
  '个文档': 'documents',
  '已编辑': 'Edited',
  '未编辑': 'Unedited',
  '点击重命名文档（同时是导出文件名）': 'Click to rename document (also the export filename)',
  '确定': 'OK',
  '取消': 'Cancel',
  '删除当前文档': 'Delete current document',
